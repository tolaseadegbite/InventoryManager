...
ActiveRecord::Schema[8.0].define(version: 2025_02_26_121011) do
  ...
  create_table "activity_logs", force: :cascade do |t|
    ...
    t.index ["inventory_id"], name: "index_activity_logs_on_inventory_id"
  ...
  add_foreign_key "activity_logs", "inventories"
